...
@section('content')
    ...
    <form action="/categories" method="post" class="mt-4 col-12 col-md-8 col-lg-6 mx-auto">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3 form-check">
            ...
            <label class="form-label" for="status"
                title="{{ __('Deactivating category will hide it from mobile app.') }}">{{ __('Active') }}</label>
        </div>
        <div class="d-flex">
